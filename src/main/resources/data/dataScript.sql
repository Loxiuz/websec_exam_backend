...
INSERT INTO `users` (id, password, username, employee_id, role_id) VALUES
    ...
    INSERT INTO export_request (export_creation, employee_id, id, export_format, file_name, selected_entities, status, applied_filters_json) VALUES
                            ...
                            (DATE('2025-08-13'),UUID_TO_BIN('3f1c4d70-0c22-4d5d-9f8d-cad3d1b8e101'),UUID_TO_BIN('1a1e9504-2fa8-4102-80c0-35b44bde515e'),'csv','exported_passenger_data.csv','passenger, booking','COMPLETED','[{"passenger":{"field":"","value":""}},{"booking":{"field":"","value":""}}]'),
                            ...
                            (DATE('2025-08-17'),UUID_TO_BIN('62d7d583-9809-4a1a-a803-a44e3156595b'),UUID_TO_BIN('98d3a4f0-1463-4f67-9f2a-a31ac4a1b111'),'json','exported_booking_data.json','booking, passenger','COMPLETED','[{"booking":{"field":"status","value":"Confirmed"}}]'),
                            (DATE('2025-08-18'),UUID_TO_BIN('3f1c4d70-0c22-4d5d-9f8d-cad3d1b8e101'),UUID_TO_BIN('a5d7d1ea-908f-4f1d-9340-894fc1b6c222'),'csv','exported_airport_report.csv','airport','COMPLETED','[{"airport":{"field":"country","value":"Denmark"}}]'),
                            (DATE('2025-08-19'),UUID_TO_BIN('9a35f0de-c2d2-4fd0-a9a2-8d00f9b8c202'),UUID_TO_BIN('b1a0c3d4-e5f6-47a8-90ab-cdef1234d333'),'json','exported_flights.json','flight','FAILED','[{"flight":{"field":"flight_number","value":"SK"}}]'),
                            (DATE('2025-08-20'),UUID_TO_BIN('7fec666c-b826-41fd-b2ed-7f383f821f23'),UUID_TO_BIN('c2b3d4e5-f6a7-48b9-91bc-def01234e444'),'csv','exported_user_audit.csv','employee, export_request','COMPLETED','[{"employee":{"field":"name","value":""}}]'),
                            (DATE('2025-08-21'),UUID_TO_BIN('f434581c-abe5-4a1b-8a7c-b7b1240193e3'),UUID_TO_BIN('d3c4e5f6-a7b8-49ca-a2cd-ef123456f555'),'csv','exported_notes_data.csv','export_notes','COMPLETED','[{"export_notes":{"field":"is_hidden","value":"false"}}]'),
                            (DATE('2025-08-22'),UUID_TO_BIN('62d7d583-9809-4a1a-a803-a44e3156595b'),UUID_TO_BIN('e1111111-1111-4111-8111-111111111111'),'csv','exported_flight_data_2.csv','flight, booking','COMPLETED','[{"flight":{"field":"","value":""}}]'),
                            (DATE('2025-08-23'),UUID_TO_BIN('3f1c4d70-0c22-4d5d-9f8d-cad3d1b8e101'),UUID_TO_BIN('e2222222-2222-4222-8222-222222222222'),'json','exported_passenger_data_2.json','passenger','COMPLETED','[{"passenger":{"field":"nationality","value":"Irish"}}]'),
                            (DATE('2025-08-24'),UUID_TO_BIN('3f1c4d70-0c22-4d5d-9f8d-cad3d1b8e101'),UUID_TO_BIN('e3333333-3333-4333-8333-333333333333'),'csv','exported_airport_data_2.csv','airport','COMPLETED','[{"airport":{"field":"country","value":"Portugal"}}]'),
                            (DATE('2025-08-25'),UUID_TO_BIN('9a35f0de-c2d2-4fd0-a9a2-8d00f9b8c202'),UUID_TO_BIN('e4444444-4444-4444-8444-444444444444'),'csv','exported_crew_data_2.csv','crew_member','FAILED','[{"crew_member":{"field":"name","value":""}}]'),
                            (DATE('2025-08-26'),UUID_TO_BIN('7fec666c-b826-41fd-b2ed-7f383f821f23'),UUID_TO_BIN('e5555555-5555-4555-8555-555555555555'),'json','exported_booking_data_2.json','booking','COMPLETED','[{"booking":{"field":"status","value":"Pending"}}]'),
                            (DATE('2025-08-27'),UUID_TO_BIN('f434581c-abe5-4a1b-8a7c-b7b1240193e3'),UUID_TO_BIN('e6666666-6666-4666-8666-666666666666'),'csv','exported_employee_data_2.csv','employee','COMPLETED','[{"employee":{"field":"email","value":"@airline.com"}}]'),
                            (DATE('2025-08-28'),UUID_TO_BIN('62d7d583-9809-4a1a-a803-a44e3156595b'),UUID_TO_BIN('e7777777-7777-4777-8777-777777777777'),'csv','exported_route_data.csv','flight, airport','COMPLETED','[{"flight":{"field":"flight_number","value":"9"}}]'),
                            (DATE('2025-08-29'),UUID_TO_BIN('62d7d583-9809-4a1a-a803-a44e3156595b'),UUID_TO_BIN('e8888888-8888-4888-8888-888888888888'),'json','exported_compliance_data.json','users, roles','FAILED','[{"users":{"field":"role_id","value":"2"}}]'),
                            (DATE('2025-08-30'),UUID_TO_BIN('3f1c4d70-0c22-4d5d-9f8d-cad3d1b8e101'),UUID_TO_BIN('e9999999-9999-4999-8999-999999999999'),'csv','exported_ops_data.csv','crew_member_assignment','COMPLETED','[{"crew_member_assignment":{"field":"role","value":"Pilot"}}]'),
                            (DATE('2025-08-31'),UUID_TO_BIN('9a35f0de-c2d2-4fd0-a9a2-8d00f9b8c202'),UUID_TO_BIN('ea000000-0000-4a00-8a00-000000000000'),'csv','exported_weekly_digest.csv','export_request, export_notes','COMPLETED','[{"export_notes":{"field":"is_hidden","value":"false"}}]'),
...
INSERT INTO export_notes (employee_id, export_request_id, id, notes, creation_date, is_hidden) VALUES
                            ...
                            (UUID_TO_BIN('3f1c4d70-0c22-4d5d-9f8d-cad3d1b8e101'), UUID_TO_BIN('1a1e9504-2fa8-4102-80c0-35b44bde515e'), UUID_TO_BIN('6b40e801-55ce-4f67-9bcf-14a8c40b2d8f'), 'Passenger data export looks good, but booking inconsistencies should be addressed.', DATE('2025-08-14 15:30:00'), false),
                            ...
                            (UUID_TO_BIN('62d7d583-9809-4a1a-a803-a44e3156595b'), UUID_TO_BIN('699710d1-fa9d-41d4-850a-f2ac31929e08'), UUID_TO_BIN('e7f8c2a3-5b6d-4e7f-9a8b-12c3d4e5f6a7'), 'Missing crew member values should be filled before publication.', DATE('2025-08-17 09:15:00'), true),
                            (UUID_TO_BIN('62d7d583-9809-4a1a-a803-a44e3156595b'), UUID_TO_BIN('98d3a4f0-1463-4f67-9f2a-a31ac4a1b111'), UUID_TO_BIN('1f2e3d4c-5b6a-47c8-9d0e-1a2b3c4d5e66'), 'Booking export completed and passed schema validation.', DATE('2025-08-18 11:10:00'), false),
                            (UUID_TO_BIN('3f1c4d70-0c22-4d5d-9f8d-cad3d1b8e101'), UUID_TO_BIN('a5d7d1ea-908f-4f1d-9340-894fc1b6c222'), UUID_TO_BIN('2a3b4c5d-6e7f-48a9-b0c1-2d3e4f5a6b77'), 'Airport report generated for Denmark routes only.', DATE('2025-08-19 08:40:00'), false),
                            (UUID_TO_BIN('9a35f0de-c2d2-4fd0-a9a2-8d00f9b8c202'), UUID_TO_BIN('b1a0c3d4-e5f6-47a8-90ab-cdef1234d333'), UUID_TO_BIN('3b4c5d6e-7f80-49ba-c1d2-3e4f5a6b7c88'), 'Flight export failed due to timeout while fetching metadata.', DATE('2025-08-20 13:25:00'), false),
                            (UUID_TO_BIN('7fec666c-b826-41fd-b2ed-7f383f821f23'), UUID_TO_BIN('c2b3d4e5-f6a7-48b9-91bc-def01234e444'), UUID_TO_BIN('4c5d6e7f-8091-4acb-d2e3-4f5a6b7c8d99'), 'User audit export finished successfully with no anomalies.', DATE('2025-08-21 17:05:00'), true),
                            (UUID_TO_BIN('f434581c-abe5-4a1b-8a7c-b7b1240193e3'), UUID_TO_BIN('d3c4e5f6-a7b8-49ca-a2cd-ef123456f555'), UUID_TO_BIN('5d6e7f80-91a2-4bdc-e3f4-5a6b7c8d9ea0'), 'Notes data export completed and shared with reporting.', DATE('2025-08-22 09:50:00'), false),
                            (UUID_TO_BIN('62d7d583-9809-4a1a-a803-a44e3156595b'), UUID_TO_BIN('e1111111-1111-4111-8111-111111111111'), UUID_TO_BIN('b1111111-1111-4111-8111-111111111111'), 'Second flight export batch completed without schema issues.', DATE('2025-08-22 10:10:00'), false),
                            (UUID_TO_BIN('3f1c4d70-0c22-4d5d-9f8d-cad3d1b8e101'), UUID_TO_BIN('e2222222-2222-4222-8222-222222222222'), UUID_TO_BIN('b2222222-2222-4222-8222-222222222222'), 'Passenger export includes extra nationality filters for QA.', DATE('2025-08-23 11:00:00'), true),
                            (UUID_TO_BIN('3f1c4d70-0c22-4d5d-9f8d-cad3d1b8e101'), UUID_TO_BIN('e3333333-3333-4333-8333-333333333333'), UUID_TO_BIN('b3333333-3333-4333-8333-333333333333'), 'Airport export validated successfully against current data.', DATE('2025-08-24 09:45:00'), false),
                            (UUID_TO_BIN('9a35f0de-c2d2-4fd0-a9a2-8d00f9b8c202'), UUID_TO_BIN('e4444444-4444-4444-8444-444444444444'), UUID_TO_BIN('b4444444-4444-4444-8444-444444444444'), 'Crew export failed after upstream timeout; retry planned.', DATE('2025-08-25 16:20:00'), false),
                            (UUID_TO_BIN('7fec666c-b826-41fd-b2ed-7f383f821f23'), UUID_TO_BIN('e5555555-5555-4555-8555-555555555555'), UUID_TO_BIN('b5555555-5555-4555-8555-555555555555'), 'Booking export completed with pending reservations highlighted.', DATE('2025-08-26 12:30:00'), true),
                            (UUID_TO_BIN('f434581c-abe5-4a1b-8a7c-b7b1240193e3'), UUID_TO_BIN('e6666666-6666-4666-8666-666666666666'), UUID_TO_BIN('b6666666-6666-4666-8666-666666666666'), 'Employee export passed internal data quality checks.', DATE('2025-08-27 14:15:00'), true),
                            (UUID_TO_BIN('62d7d583-9809-4a1a-a803-a44e3156595b'), UUID_TO_BIN('e7777777-7777-4777-8777-777777777777'), UUID_TO_BIN('b7777777-7777-4777-8777-777777777777'), 'Route export completed and sent to planning team.', DATE('2025-08-28 08:55:00'), false),
                            (UUID_TO_BIN('62d7d583-9809-4a1a-a803-a44e3156595b'), UUID_TO_BIN('e8888888-8888-4888-8888-888888888888'), UUID_TO_BIN('b8888888-8888-4888-8888-888888888888'), 'Compliance export failed due to role mapping mismatch.', DATE('2025-08-29 18:05:00'), false),
                            (UUID_TO_BIN('3f1c4d70-0c22-4d5d-9f8d-cad3d1b8e101'), UUID_TO_BIN('e9999999-9999-4999-8999-999999999999'), UUID_TO_BIN('b9999999-9999-4999-8999-999999999999'), 'Operations export generated successfully for pilot assignments.', DATE('2025-08-30 07:35:00'), false),
                            (UUID_TO_BIN('9a35f0de-c2d2-4fd0-a9a2-8d00f9b8c202'), UUID_TO_BIN('ea000000-0000-4a00-8a00-000000000000'), UUID_TO_BIN('ba000000-0000-4a00-8a00-000000000000'), 'Weekly digest export completed and archived.', DATE('2025-08-31 19:25:00'), true),
