...
INSERT INTO export_notes (employee_id, export_request_id, id, notes, creation_date, is_hidden) VALUES
                            ...
                            (UUID_TO_BIN('a197665b-5fa9-4bf7-8344-2cc303a15f09'), UUID_TO_BIN('699710d1-fa9d-41d4-850a-f2ac31929e08'), UUID_TO_BIN('6b40e801-55ce-4f67-9bcf-14a8c40b2d8f'), 'The passenger data export looks good, but there are some inconsistencies in the booking data that need to be addressed.', DATE('2025-08-14 15:30:00'), false),
